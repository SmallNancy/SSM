...
import cn.nancy.service.impl.AccountServiceImpl;
@WebServlet("/transfer")
...
protected void service(HttpServletRequest req, HttpServletResponse resp) 
	 ...
	 accOut.setAccnumber(req.getParameter("accOutAccNo"));
